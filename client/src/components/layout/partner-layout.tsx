...
import { usePartnerAuth, usePartnerLogout } from "@/hooks/use-auth";
import { Skeleton } from "@/components/ui/skeleton";

const navItems = [
  { title: "Dashboard", href: "/partner/dashboard", icon: LayoutDashboard },
  { title: "Licenses", href: "/partner/licenses", icon: Key },
  { title: "Generate Keys", href: "/partner/generate", icon: Plus },
        ...
        <Sidebar>
          <SidebarHeader className="p-4">
            <div className="flex flex-col gap-1">
              <span className="text-sm font-semibold" data-testid="text-partner-name">
                Partner Portal
              </span>
              {user.name && (
                <span className="text-xs text-muted-foreground" data-testid="text-partner-user">
                  {user.name}
                </span>
              )}
            </div>
